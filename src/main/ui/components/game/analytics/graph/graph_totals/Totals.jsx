...
const Totals = () => {
	...
	const [ animationResult, setAnimationResult ] = useState (false);
	const [ percentAnswers, setPercentAnswers ] = useState (75);
	// let fm;

	const onAnimationResult = () => {
		setAnimationResult(!animationResult);
	};

	// const fluidMeterMemo = useCallback( () => {
	//
	// 	fm = new FluidMeter ();
	// 	fm.init ({
	...
	return (
		<div className={styles.totals__wrap}>
			...
			<div className={styles.totals__canvas} onClick={onAnimationResult} id="fluid-meter"></div>
