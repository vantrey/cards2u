...
import styles from './StopTest.module.css';
import bg_1 from './../../../images/card-bg/card-bg-38.jpg';
...
const StopTest = ({ setCardFace, setCardBg }) => {
			...
			<div className={styles.card__wrap}>
				<div className={styles.card}>
					...
					<div className={styles.card__content}>
						<h2 className={styles.card__title}>Result</h2>
