const Qw_1 = {
    qwestion: 'В каких случаях Class Component лучше, чем Functional Component?',
...
const Qw_2 = {
    qwestion: 'Что такое refs и с чем их едят?',
...
const Qw_3 = {
    qwestion: 'Разница между компонентами controlled и uncontrolled?',
...
const Qw_4 = {
    qwestion: 'Как React JS Использует Ключи?',
...
const Qw_5 = {
    qwestion: 'Почему React.Children.map(props.children, () => ), а не props.children.map(() => )?',
...
const Qw_6 = {
    qwestion: 'Опишите обработку событий в React.JS',
...
const Qw_7 = {
    qwestion: 'Как заставить компонент React перерендерится?',
...
const Qw_8 = {
    qwestion: 'Что произойдет, если передать функцию в метод setState ?',
...
const Qw_9 = {
    qwestion: 'Что такое порталы(Portals)?',
...
const Qw_10 = {
    qwestion: 'Что такое чистый компонент и когда он должен использоваться ?',
...
const Qw_11 = {
    qwestion: 'Что такое поднятие состояния вверх по иерархии в React (Lifting State Up)?',
...
const Qw_12 = {
    qwestion: 'Что такое React Reconciliation (Cверка) и как он работает?',
...
const Qw_13 = {
    qwestion: 'При создании HOC,как узнать,что оборачиваемый компонент явяеться реакт компонетом' +
...
const Qw_14 = {
    qwestion: 'Что значит компонент mounted?',
    answer: 'Шаблон компонента соединен с DOM деревом'
};
const Qw_15 = {
    qwestion: 'В setState можно передавать объект или функцию. В чем разница и что лучше использовать?',
...
const Qw_16 = {
    qwestion: 'Назовите разницу между Презентационным и Контейнер компонентом?',
...
const Qw_17 = {
    qwestion: 'Что такое и для чего используються Higher-Order компоненты?',
...
const Qw_21 = {
    qwestion: 'Что такое Error Boundaries в React?',
...
const Qw_22 = {
    qwestion: 'В чем разница между useRef и createRef?',
...
const Qw_23 = {
    qwestion: 'Что такое prop drilling и как этого избежать?',
...
const Qw_26 = {
    qwestion: 'Как работает проп children?',
...
const Qw_27 = {
    qwestion: 'Можно создавать анимации в React?',
...
const Qw_28 = {
    qwestion: 'Что не так с этим кодом?\n' +
...
const Qw_29 = {
    qwestion: 'Какой второй опциональный параметр можно передать в метод setState и за что он отвечает?',
    answer: 'Функция, уведомляющая, что компонент закончил процесс ре-рендеринга.'
};
const Qw_30 = {
    qwestion: 'Что такое React Fiber?',
...
const Qw_31 = {
    qwestion: 'Разница между Flow и PropTypes?',
...
const Qw_32 = {
    qwestion: 'Правда ли, что React делает ре-рендер всех компонентов и\n' +
...
const Qw_33 = {
    qwestion: 'Как можно улучшить производительность React приложения?',
...
const Qw_34 = {
    qwestion: 'Что можно сделать с помощью хуков, чего невозможно добиться, используя классы?',
    answer: 'Хуки дают новый мощный способ повторного использования кода в компонентах.'
};
const Qw_35 = {
    qwestion: 'Являются ли хуки заменой рендер-пропсам и компонентам высшего порядка?',
...
const Qw_36 = {
    qwestion: 'Безопасно ли не указывать функции в списке зависимостей useEffect?',
...
const Qw_37 = {
    qwestion: 'Как избежать передачи колбэков вниз(Hooks)?',
...
const Qw_38 = {
    qwestion: 'Как React связывает вызовы хуков с компонентом?',
...
const Qw_39 = {
    qwestion: 'Почему нельзя использовать HOC внутри render метода.',
...
const Qw_40 = {
    qwestion: 'Может ли HOC передать оборачиваемому копонету ref?Почему так?',
...
const Qw_42 = {
    qwestion: 'Почему нельзя использовать  рендер-проп вместе с React.PureComponent?',
...
const Qw_43 = {
    qwestion: 'Зачем нужен хук useReducer?',
...
const Qw_44 = {
    qwestion: 'Как пользовательский хук получает изолированное состояние?',
...
const Qw_47 = {
    qwestion: 'Что такое доступность контента?',
...
const Qw_48 = {
    qwestion: 'Назовите основные этапы жизненного цикла компонента',
...
const Qw_49 = {
    qwestion: ' Что такое JEST?', answer: 'JavaScript фреймворк, для юнит тестирования на основе Jasmine. Разработал' +
        'Facebook. Очень удобен именно для React'
};
const Qw_50 = {
    qwestion: ' В чем разница между state и props?',
...
const Qw_51 = {
    qwestion: ' Что происходит, когда вы вызываете setState?',
...
const Qw_59 = {
    qwestion: ' Что такое reducer?',
    answer: ' Простая чистая функция, принимающая state и action и модифицирующая state '
};
const Qw_60 = {
    qwestion: ' Что такое mapStateToProps и mapDispatchToProps??',
...
let questionArray =[Qw_1,Qw_2,Qw_3,Qw_4,Qw_5,Qw_6,Qw_7,Qw_8,Qw_9,Qw_10,Qw_11,Qw_12,Qw_13,Qw_14,Qw_15,Qw_16,Qw_17,Qw_18,Qw_19,
    ...
    Qw_39,Qw_40,Qw_41,Qw_42,Qw_43,Qw_44,Qw_45,Qw_46,Qw_47,Qw_48,Qw_49,Qw_50,Qw_51,Qw_52,Qw_53,Qw_54,Qw_55,Qw_56,Qw_57,Qw_58,Qw_59,Qw_60]
