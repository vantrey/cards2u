const Qw_1 = {
    ...
    answer1: `Логичекое и`,
    answer2: `Логическое или`,
    answer3: `Лочиеское не`

};

const Qw_2 = {
    question: `Что такое null?`,
    answer1: `Значение по умолчанию`,
    answer2: `тоже,что и Infinity`,
    answer3: `значение 'отсутствия значения'`

};

const Qw_3 = {
    question: `В каком случае строка не будет приеобразована в число`,
    answer1: `+'1'`,
    answer2: `Number('123z')`,
    answer3: `'6'/'2'`
...
const Qw_4 = {
    question: `Какой самый быстрый способ преобразования  в число`,
    answer1: `Number`,
    answer2: `/,*,^,Math.pow,бинарный +,унарный -`,
    answer3: `унарный +`

};

const Qw_5 = {
    question: `Что такое текущая цель события`,
