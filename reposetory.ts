                        ...
                        favoriteDecks: [
                            {
                                favoriteDeckId: 'favoriteDeckSlot0', deckName: 'React Native', deck: [
                                    ...
                                    {
                                        answer: `Контролируемый компонент обладает своим стейтом,управляемый React.Неконтролируемый  обладает внутренним состоянием`,
                                    ...
                                    {
                                        answer: `Так, чтобы провести границу между простыми виртуальными элементами DOM и теми которые являются уникальными.`,
                                    ...
                                    },
                                    {
                                        ...
                                        answer: `Порталы отображают дочерние элементы в узел DOM,который существует вне иерархии DOM родительского компонента`,
                                        question: 'Что такое порталы(Portals)?',
                                        wrongAnswers: [`Порталы отображают дочерние элементы в узел DOM,который существует в пределах иерархии DOM родительского компонента,в любом направлении`, `Порталы отображают любые элементы в узел DOM,который существует влюбом месте приложения`],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: `Тоже самое, что и Component, кроме того, что автоматически за вас реализует метод shouldComponentUpdate.`,
                                        ...
                                        answer: `Общее состояние нескольких компонент,которое должно быть поднято до ближайшего общего предка`,
                                        ...
                                        wrongAnswers: ['Да. Это правильный синтаксис React.js для обработки событий кликов.',`Этот код впринципе неправильно написан,так как тэг button должен быть самозакрывающийся`],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        question: 'Какое из этих утверждений относительно props истинны?',
                                        wrongAnswers: [' React автоматически проверяет переданны ли необходимые props','дочерний компонент наследует props родительского компонента'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: '{fetch()}',
                                        question: 'Каким образом можно получить доступ к функции fetch() из элемента h1 в JSX?',
                                        wrongAnswers: ['{fetch}', '${fetch()}'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: 'Ошибка переполнения стека',
                                        question: 'Что происходит при вызове setState() внутри метода render()?',
                                        wrongAnswers: ['На экране появятся повторяющиеся выходные данные', 'Ничего не произойдет'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: `if(BaseComponent.prototype.isReactComponent){//add props}`,
                                    ...
                                    ,и если нет,как добавить ему новые props?`,
                                        wrongAnswers: [`if(WrappedComponent.prototype.isReactComponent){//add props }`, 'Как обычно передать сверху-вниз'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: `Презентационный - Нужен для создания интерфейса.Работает на входящих параметрах.Контейнер - обладают состоянием, подключен к Flux или Redux`,
                                        question: 'Назовите разницу между Презентационным и Контейнер компонентом?',
                                        wrongAnswers: [`Контейнер-Нужен для создания интерфейса. Работает на входящих параметрах.Презентационный-обладают состоянием, подключен к Flux или Redux`,'В React  все компоненты исключительно являются контэйнерами,так, как это удобно'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: `Higher-order component (HOC) - функции, у которых входящий параметр компонент. Возвращают новый компонент с добавленным поведением`,
                                        ...
                                        wrongAnswers: [`Потому что запуститься бесконечный рэндер', 'Будет перерэндерено все дерево Virtual DOM,что скажется на производительности`],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`[event.currentTarget.name]:event.target.value`,`[event.currentTarget.name]:event.currentTarget.value`],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        answer: `createRef - всегда создает новую ссылку. Используется в class компонентах,useRef - возвращает одинаковую ссылку на объект`,
                                        question: 'В чем разница между useRef и createRef?',
                                        wrongAnswers: [`useRef-всегда создает новую ссылку. Используется в class компонентах createRef-возвращает одинаковую ссылку на объект  `, '1-работает только с Virtual DOM,второй только с DOM деревом'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Какждый раз создавать локальное состояние,использовать меньше контэйнерных компонент,иметь минимальную вложенность приложения и как можно реже прокидывать пропсы `,'Использовать MVC паттерн'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Для избежания падения производительности приложения`,'Для эффективного тестирования компонент приложения'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Вместо prevProps,нужно было указать state`,'в setState  нужно было передать функцию,что бы работать с текущими пропсами'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`На хуках приложение работает быстрее,за счёт отсутствия методов жизненого цикла `, 'С хуками  не ненужно больше использовать локальное состояние в компоненте'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Простая чистая функция, принимающая state и action и не модифицирующая state `,'Компонент высшего порядка в которой производяться  запросы с есревера,делаются все сторонние эффекты'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Да`,'Можно,только если классовый компонент являеться контэйнером'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Да,хуки уменьшают вложенность,и полностью способны заменить HOC и рэндер-пропсы`,'Нет,хуки выполняют совсем иную роль'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Да,безопасно`,`Безопасно,если  объявить функции нужные эффекту сразу после эффекта`],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Через useContext`,'С помощью store'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Состояние для всех пользовательских хуков не изалировано`, 'Да только если его вызов будет обёрнуть в useMemo'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Что бы пользоваться сохранённым в редьюссере сосоянием  в любой  месте приложения`, 'Позволяет сохранять данные минуя экшены'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
                                        ...
                                        wrongAnswers: [`Хук позволяющий запускать сторонние эффекты,напримеры логирование`, 'Хук исполльзующий глобальное сосотояние приложения'],
                                        cardsPack_id: '0',
                                        grade: 0,
                                        rating: 0,
                                        shots: 0,
